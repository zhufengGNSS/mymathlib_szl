////////////////////////////////////////////////////////////////////////////////
// File: runge_kutta_gill.c                                                   //
// Routines:                                                                  //
//    Runge_Kutta_Gill                                                        //
//    Runge_Kutta_Gill_Richardson                                             //
//    Runge_Kutta_Gill_Integral_Curve                                         //
...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
double Runge_Kutta_Gill( double (*f)(double, double), double y0, double x0,
...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
double Runge_Kutta_Gill_Richardson( double (*f)(double, double), double y0,
   ...
   while ( --number_of_steps >= 0 ) {
      ...
      for (j = 0; j < richardson_columns; j++) {
         integral = Runge_Kutta_Gill( f, y0, x0, h_used, number_sub_intervals);
         for ( k = 0; k < j; k++) {
            delta = integral - dt[k];
            dt[k] = integral;
...
////////////////////////////////////////////////////////////////////////////////
//  void Runge_Kutta_Gill_Integral_Curve( double (*f)(double, double),        //
...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
void Runge_Kutta_Gill_Integral_Curve( double (*f)(double, double), double y[],
   ...
   while ( --number_of_intervals >= 0 ) {
      *(y+1) = *y;
      ...
      for (i = 0; i < number_of_steps_per_interval; i++) {
         k1 = (*f)(x0,*y);
         k2 = (*f)(x0+h2, *y + h2 * k1);
         k3 = (*f)(x0+h2, *y + h * (b31 * k1 + b32 * k2) );
         x0 += h;
         k4 = (*f)(x0, *y + h * (b42 * k2 + b43 * k3));
         *y += h6 * ( k1 + c2 * k2 + c3 * k3 + k4 );
      }
   }
}
...
////////////////////////////////////////////////////////////////////////////////
//  void Runge_Kutta_Gill_Richardson_Integral_Curve(                          //
...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
void Runge_Kutta_Gill_Richardson_Integral_Curve( double (*f)(double, double),
             double y[], double x0, double h, int number_of_steps_per_interval,
   ...
   while ( --number_of_intervals >= 0 ) {
      *(++y) = Runge_Kutta_Gill_Richardson( f, *y, x0, h,
