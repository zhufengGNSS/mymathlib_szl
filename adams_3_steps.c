////////////////////////////////////////////////////////////////////////////////
// File: adams_3_steps.c                                                      //
// Routines:                                                                  //
//    Adams_3_Steps                                                           //
//    Adams_Bashforth_3_Steps                                                 //
//    Adams_Moulton_2_Steps                                                   //
//    Adams_3_Build_History                                                   //
////////////////////////////////////////////////////////////////////////////////
...
static const double bashforth[] = {  23.0, -16.0, 5.0 };
static const double moulton[] = {  5.0, 8.0, -1.0 };
static const double divisor = 1.0 / 12.0;

#define STEPS sizeof(bashforth)/sizeof(bashforth[0])

double Adams_Bashforth_3_Steps( double y, double h, double f_history[] );
int Adams_Moulton_2_Steps( double (*f)(double, double), double y[], double x, 
             double h, double f_history[], double tolerance, int iterations );
static int hasConverged(double y0, double y1, double epsilon);

////////////////////////////////////////////////////////////////////////////////
// int Adams_3_Steps( double (*f)(double, double), double y[], double x0,     //
...
//     i = 1, 2, stored in the array f_history[], and y(x0) stored in y[0].   //
//                                                                            //
//  Arguments:                                                                //
...
//                f_history[i] = f( x0-(2-i)*h, y(x0-(2-i)*h) ), i = 0, 1.    //
//                On output, the updated history list,                        //
//                f_history[i] = f( x0-(1-i)*h, y(x0-(1-i)*h) ), i = 0, 1.    //
//                On the initial call to this routine, f_history[i],          //
//                i = 0, 1, must be initialized by the calling routine.       //
//                Thereafter this function maintains the array.               //
//                The array f_history[] must be dimensioned at least 3 in     //
//                the calling routine.  If the values y(x0-2*h), y(x0-h)      //
//                are given, the user may call Adams_3_Build_History, given   //
//                below, to initialize the array f_history[].                 //
...
int Adams_3_Steps( double (*f)(double, double), double y[], double x0, 
   ...
   *y_bashforth  = Adams_Bashforth_3_Steps( y[0], h, f_history );
   for (i = 0; i < STEPS - 1; i++) f_history[i] = f_history[i+1];

          // Calculate the corrector using the Adams-Moulton formula 
   
   y[1] = *y_bashforth;
   return Adams_Moulton_2_Steps( f, y, x0+h, h, f_history, tolerance,
                                                               iterations );
}
...
//     uses the starting values f(x0-i*h,y(x0-i*h)), i = 0, 1, 2, stored in   //
//     the arraay f_history[] and the input argument y = y(x0).               //
//                                                                            //
//  Arguments:                                                                //
...
//                f_history[i] = f( x0-(2-i)*h, y(x0-(2-i)*h) ), i = 0, 1.    //
//                The array f_history[] must be dimensioned at least 3 in the //
//                calling routine.                                            //
//                                                                            //
//  Return Values:                                                            //
...
////////////////////////////////////////////////////////////////////////////////
// int Adams_Moulton_2_Steps( double (*f)(double, double), double y[],        //
...
//     using starting values f(x-i*h,y(x-i*h)), i = 1, 2, stored in the array //
//     f_history[], the value of y(x-h) stored in y[0] and the initial        //
...
//                f_history[i] = f( x-(2-i)*h, y(x-(2-i)*h) ), i = 0, 1.  The //
//                array f_history[] must be dimensioned at least 2 in the     //
//                calling routine.                                            //
//     double tolerance    The terminating tolerance for the corrector part   //
//                predictor-corrector pair.  This is not the error bounds for //
//                the solution y(x).                                          //
...
////////////////////////////////////////////////////////////////////////////////
// void Adams_3_Build_History(double (*f)(double,double), double f_history[], //
...
//     y[i] = y(x + i*h) for i = 0,..., 2 are given.  Then f_history[i] =     //
//     f(x+i*h,y[i]).                                                         //
//                                                                            //
//  Arguments:                                                                //
//     double *f  Pointer to the function which returns the slope at (x,y) of //
...
//                f_history[2] = f(x+2*h,y[2]).                               //
//                The array f_history must be dimensioned at least 3.         //
